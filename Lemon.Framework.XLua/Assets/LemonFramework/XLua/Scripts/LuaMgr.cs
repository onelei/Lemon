...
namespace Lemon.Framework
{
    ...
    {
        private static string LuaProjectPath = Path.Combine(Application.dataPath, "LemonFramework/XLua/LuaProject/");
        ...
        public static void AddLoader(string luaFileName)
        {
            ...
            {
                filename = Path.Combine(LuaProjectPath, filename.Replace('.', '/') + ".lua");
