...
namespace LemonFramework
{
    public partial class UIBase : UIBaseBehavior
    {
        ...
        private string UI_TEMPLATE_PATH
        {
            get
            {
                return Application.dataPath + "/LemonFramework/Scripts/UI/UITemplate/UITemplate_Generate.cs";
            }
        }
        ...
        public void GenerateCodeEditor()
        {
            ...
            string uiBasePath = StringUtility.Format(Application.dataPath + "/LemonFramework/Scripts/UI/{0}/{1}_Generate.cs", uIBase.name, uIBase.name);
