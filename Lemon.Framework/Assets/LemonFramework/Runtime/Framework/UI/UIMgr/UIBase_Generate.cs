...
namespace Lemon.Framework
{
    public partial class UIBase : UIBaseBehavior
    {
        ...
        private string UI_TEMPLATE_PATH
        {
            get
            {
                return Application.dataPath + "/Lemon.Framework/Scripts/UI/UITemplate/UITemplate_Generate.cs";
            }
        }
        ...
        {
            {"QButton", typeof(LemonButton)},
            {"LemonRawImage", typeof(LemonRawImage)},
            {"LemonImage", typeof(LemonImage)},
            {"LemonText", typeof(LemonText)},
            {"LemonToggleButton", typeof(LemonToggleButton)},
            {"LemonToggleButtonGroup", typeof(LemonToggleButtonGroup)}
        };
        ...
        public void GenerateCodeEditor()
        {
            ...
            string uiBasePath = StringUtility.Format(Application.dataPath + "/Lemon.Framework/Scripts/UI/{0}/{1}_Generate.cs", uIBase.name, uIBase.name);
